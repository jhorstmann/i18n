...
public class WebMessageExtractor extends AbstractExtractorHandler implements MessageExtractor {
    ...
    static {
        ...
        functions.add(MessageFunction.fromEL(ns, "tr1(message)"));
        functions.add(MessageFunction.fromEL(ns, "tr2(message)"));
        functions.add(MessageFunction.fromEL(ns, "tr3(message)"));
        functions.add(MessageFunction.fromEL(ns, "tr4(message)"));
        functions.add(MessageFunction.fromEL(ns, "trc(context, message)"));
        functions.add(MessageFunction.fromEL(ns, "trc1(context, message)"));
        functions.add(MessageFunction.fromEL(ns, "trc2(context, message)"));
        functions.add(MessageFunction.fromEL(ns, "trc3(context, message)"));
        functions.add(MessageFunction.fromEL(ns, "trc4(context, message)"));
        functions.add(MessageFunction.fromEL(ns, "trn(message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trn1(message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trn2(message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trn3(message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trn4(message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trnc(context, message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trnc1(context, message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trnc2(context, message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trnc3(context, message, plural, long)"));
        functions.add(MessageFunction.fromEL(ns, "trnc4(context, message, plural, long)"));
